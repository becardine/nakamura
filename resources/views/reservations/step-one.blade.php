<x-guest-layout>
	<div class="container w-full px-5 py-6 mx-auto">
			<div class="flex items-center min-h-screen mb-12">
					<div class="flex-1 h-full max-w-4xl mx-auto bg-slate-100 rounded-lg shadow-xl">
							<div class="flex flex-col md:flex-row">
									<div class="h-32 md:h-auto md:w-1/2">
											<img class="object-cover w-full h-full rounded-l"
													src="{{asset('images/res-step-one.jpg')}}" alt="img" />
									</div>
									<div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
											<div class="w-full">
													...
													<div class="w-full bg-gray-200 rounded-full mb-8">
															<div
																	class="w-40 p-1 text-xs font-medium leading-none text-center text-red-100 bg-red-700 rounded-full">
																	Step1</div>
													</div>
													...
													<form method="POST" action="{{ route('reservations.store.step.one') }}">
															...
															<div class="mt-6 flex justify-end">
																	<button type="submit"
																			class="px-8 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-white">Next</button>
															</div>
													</form>
											</div>
									</div>
