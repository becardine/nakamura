<x-guest-layout>
    <!-- Main Hero Content -->
    <div class="main-hero py-32 mx-auto -mt-24 text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center" style="background-image: url('{{ asset('images/banner-1.jpg') }}')">
    </div>
